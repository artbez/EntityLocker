...
import iimetra.example.concurrent.lock.locker.GlobalSupportEntityLocker;
...
@JCStressTest
@Description("Test concurrent modification protected code with 2 global and 1 local locks")
...
public class LocalGlobalGlobalRaceTest {
